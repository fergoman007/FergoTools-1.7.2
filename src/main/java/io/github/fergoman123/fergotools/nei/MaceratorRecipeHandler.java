...
public class MaceratorRecipeHandler extends TemplateRecipeHandler
{
    ...
    public String getRecipeName() {
        return NameHelper.translateToLocal(Locale.neiMacerator);
    }
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if (outputId.equals("smelting") && getClass() == MaceratorRecipeHandler.class) {//don't want subclasses getting a hold of this
            Map<ItemStack, ItemStack> recipes = (Map<ItemStack, ItemStack>) MaceratorRecipes.macerating().getSmeltingList();
    ...
    public void loadUsageRecipes(String inputId, Object... ingredients) {
        if (inputId.equals("fuel") && getClass() == MaceratorRecipeHandler.class)//don't want subclasses getting a hold of this
    ...
    private static void findFuels() {
        ...
        for (ItemStack item : ItemList.items)
            if (!efuels.contains(item.getItem())) {
                int burnTime = TileEntityMacerator.getItemBurnTime(item);
                if (burnTime > 0)
