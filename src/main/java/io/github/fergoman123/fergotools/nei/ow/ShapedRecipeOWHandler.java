package io.github.fergoman123.fergotools.nei.ow;
...
import io.github.fergoman123.fergotools.crafting.ow.ShapedRecipesOW;
 ...
 */
public class ShapedRecipeOWHandler extends TemplateRecipeHandler
{
    public class CachedShapedRecipe extends CachedRecipe
    {
        ...
        public CachedShapedRecipe(ShapedRecipesOW recipe) {
    ...
    public Class<? extends GuiContainer> getGuiClass() {
        return GuiObsidianWorkbench.class;
    }

    @Override
    public String getRecipeName() {
        return NameHelper.translateToLocal(Locale.neiCraftingShaped);
    }

    @Override
    public void loadCraftingRecipes(String outputId, Object... results) {
        if (outputId.equals("crafting") && getClass() == ShapedRecipeOWHandler.class) {
            for (IRecipe irecipe : (List<IRecipe>) CraftingManagerOW.getInstance().getRecipeList()) {
                CachedShapedRecipe recipe = null;
                if (irecipe instanceof ShapedRecipesOW)
                    recipe = new CachedShapedRecipe((ShapedRecipesOW) irecipe);
    ...
    public String getGuiTexture() {
        return "FergoTools:textures/gui/workbench/obsidianWorkbench.png";
    }
