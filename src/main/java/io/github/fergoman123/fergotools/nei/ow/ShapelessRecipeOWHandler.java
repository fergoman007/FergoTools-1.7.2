...
import io.github.fergoman123.fergotools.crafting.ow.ShapelessRecipesOW;
 ...
 */
public class ShapelessRecipeOWHandler extends ShapedRecipeOWHandler
{
...
//
    ...
    public String getRecipeName() {
        return NameHelper.translateToLocal(Locale.neiCraftingShapeless);
    }

    @Override
    public void loadCraftingRecipes(String outputId, Object... results) {
        if (outputId.equals("crafting") && getClass() == ShapelessRecipeOWHandler.class) {
            List<IRecipe> allrecipes = CraftingManagerOW.getInstance().getRecipeList();
            for (IRecipe irecipe : allrecipes) {
                CachedShapelessRecipe recipe = null;
                if (irecipe instanceof ShapelessRecipesOW)
                    recipe = shapelessRecipe((ShapelessRecipesOW) irecipe);
    ...
    private CachedShapelessRecipe shapelessRecipe(ShapelessRecipesOW recipe) {
