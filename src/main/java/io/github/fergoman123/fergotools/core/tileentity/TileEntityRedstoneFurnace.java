...
public class TileEntityRedstoneFurnace extends TileEntityFurnaceFT
{
    ...
    public int getCookProgressScaled(int speed) {
        return this.cookTime * speed / FurnaceInts.redstoneFurnaceSpeed;
    }
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockRedstoneFurnace.updateBlockState(this.isBurning(), this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
