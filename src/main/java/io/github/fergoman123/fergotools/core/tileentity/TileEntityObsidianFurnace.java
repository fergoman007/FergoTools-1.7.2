...
public final class TileEntityObsidianFurnace extends TileEntityFurnaceFT {
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        for (int i = 0; i < list.tagCount(); ++i){
            ...
            if (b0 >= 0 && b0 < this.slots.length){this.slots[b0] = ItemStack.loadItemStackFromNBT(compound1);}
        }
            ...
            if (this.burnTime == 0 && this.canSmelt()){
                ...
                if (this.burnTime > 0){
                    ...
                    if (this.slots[1] != null){
                        ...
                        if (this.slots[1].stackSize == 0){this.slots[1] = slots[1].getItem().getContainerItem(slots[1]);}
                    }}}
