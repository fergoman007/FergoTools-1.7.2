...
public class ItemBlockCoalFurnaceActive extends ItemBlockFT
{


    public ItemBlockCoalFurnaceActive(Block block) {
        super(ModBlocks.coalFurnaceActive);
    }
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean extraInfo) {
        ...
        {
            list.add(NameHelper.translateToLocal(Names.Locale.coalFurnaceSpeed));
        }
        else
        {
