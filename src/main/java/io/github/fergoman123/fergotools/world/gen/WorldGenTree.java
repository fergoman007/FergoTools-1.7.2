...
{
    private final int minTreeHeight, randomTreeHeight;

    private final boolean vinesGrow;

    private final Block wood, leaves;

    private final int metaWood;
    private int metaLeaves;
    private boolean isFruitTree = false;

    public WorldGenTree(Block wood, Block leaves, int metaWood, int metaLeaves)
    {
        this(wood, leaves, metaWood, metaLeaves, false, 4, 3, false);
    }

    public WorldGenTree(Block wood, Block leaves, int metaWood, boolean isFruitTree)
    {
        this(wood, leaves, metaWood, -1, false, 5, 4, false);
        this.isFruitTree = isFruitTree;
    }

    public WorldGenTree(Block wood, Block leaves, int metaWood, int metaLeaves, boolean doBlockNotify, int minTreeHeight, int randomTreeHeight, boolean vinesGrow)
    {
        super(doBlockNotify);
        this.wood = wood;
        this.leaves = leaves;
