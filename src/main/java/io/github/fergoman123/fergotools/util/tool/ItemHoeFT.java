...
package io.github.fergoman123.fergotools.util.tool;
 ...
 public class ItemHoeFT extends ItemHoe
 {
     ...
     public ItemHoeFT(ToolMaterial material, Item repairItem) {
         super(material);
     ...
     {
         itemIcon = register.registerIcon(String.format("%s%s/%s/%s", Reference.textureLoc, "tool", "hoe", NameHelper.getUnwrappedUnlocalizedName(this.getUnlocalizedName())));
     }
