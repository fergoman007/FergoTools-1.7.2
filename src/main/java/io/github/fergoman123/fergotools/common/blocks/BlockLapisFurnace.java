...
import io.github.fergoman123.fergotools.common.tileentity.TileLapisFurnace;
...
public class BlockLapisFurnace extends BlockFurnaceFT
{
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        else if (!playerIn.isSneaking())
        {
            ...
            if (furnace != null)
            {
                playerIn.openGui(FergoTools.instance, GuiIds.lapisFurnace.ordinal(), worldIn, pos.getX(), pos.getY(), pos.getZ());
                FergoTools.getLogger().info("Open Lapis Furnace");
            }
            return true;
        }
        else
