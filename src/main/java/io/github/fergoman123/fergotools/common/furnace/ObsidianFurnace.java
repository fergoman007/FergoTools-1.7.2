        ...
        ObsidianFurnace
{
    public static final class BlockObsidianFurnace extends BlockFurnaceFT
    {
        ...
        public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ) {
            if(!worldIn.isRemote && !playerIn.isSneaking())
            {
                ...
                if (furnace != null)
                {
                    openGui(FergoTools.instance, GuiIds.obsidianFurnace.ordinal(), worldIn, pos, playerIn);
    ...
    public static final class TileObsidianFurnace extends TileFurnaceFergo
    {
        @Override
        public String getCommandSenderName() {
            return this.hasCustomName() ? this.customName : Locale.containerObsidianFurnace;
        }
        ...
        public int getFurnaceSpeed(ItemStack stack) {
            return FurnaceConstants.Speed.obsidianFurnace;
        }
    ...
    public static final class ContainerObsidianFurnace extends ContainerFurnaceFergo
    {
    ...
    public static final class GuiObsidianFurnace extends GuiFurnaceFergo
    {
        public GuiObsidianFurnace(InventoryPlayer invPlayer, IInventory furnace)
        {
            super(new ContainerObsidianFurnace(invPlayer, furnace), invPlayer, furnace);
        }
        ...
        public void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
        {
            ...
            GuiHelper.bindTexture(Textures.obsidianFurnaceGui);
