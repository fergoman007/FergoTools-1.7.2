...
import io.github.fergoman123.fergotools.common.tileentities.TileRedstoneFurnace;

public class BlockRedstoneFurnace extends BlockBases.BlockFurnaceFT
{
    ...
    public Block getBlockDropped() {
        return ModBlocks.redstoneFurnaceIdle;
    }
