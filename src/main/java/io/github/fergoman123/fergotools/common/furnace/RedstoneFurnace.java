...
{
    public static final class BlockRedstoneFurnace extends BlockFurnaceFT
    {
        ...
        public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ) {
            if (!worldIn.isRemote && !playerIn.isSneaking())
            {
                ...
                if (furnace != null)
                {
                    openGui(FergoTools.instance, GuiIds.redstoneFurnace.ordinal(), worldIn, pos, playerIn);
        ...
        public static void setState(boolean active, World world, BlockPos pos)
        {
            ...
            if (active)
            {
                world.setBlockState(pos, BlockStateHelper.getStateWithProps(ModBlocks.redstoneFurnaceActive, FACING, state.getValue(FACING)), 3);
                world.setBlockState(pos, BlockStateHelper.getStateWithProps(ModBlocks.redstoneFurnaceActive, FACING, state.getValue(FACING)), 3);
            }
            else
            {
                world.setBlockState(pos, BlockStateHelper.getStateWithProps(ModBlocks.redstoneFurnaceIdle, FACING, state.getValue(FACING)), 3);
                world.setBlockState(pos, BlockStateHelper.getStateWithProps(ModBlocks.redstoneFurnaceIdle, FACING, state.getValue(FACING)), 3);
            }
    ...
    public static final class TileRedstoneFurnace extends TileFurnaceFergo
    {
        @Override
        public String getCommandSenderName() {
            return this.hasCustomName() ? this.customName : Locale.containerRedstoneFurnace;
        }
        ...
        public int getFurnaceSpeed(ItemStack stack) {
            return FurnaceConstants.Speed.redstoneFurnace;
        }
    ...
    public static final class ContainerRedstoneFurnace extends ContainerFurnaceFergo
    {
        ...
        public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int slotIndex){
            ...
            if (slot != null && slot.getHasStack()){
                ...
                if (slotIndex == 2){
                    ...
                    }else if (TileRedstoneFurnace.isItemFuel(itemstack1)){
    ...
    public static final class GuiRedstoneFurnace extends GuiFurnaceFergo
    {
        public GuiRedstoneFurnace(InventoryPlayer invPlayer, IInventory furnace)
        {
            super(new ContainerRedstoneFurnace(invPlayer, furnace), invPlayer, furnace);
        }
        ...
        public void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
        {
            ...
            GuiHelper.bindTexture(Textures.redstoneFurnaceGui);
            int startX = (width - xSize) / 2;
            int startY = (height - ySize) / 2;
            drawTexturedModalRect(startX, startY, 0, 0, xSize, ySize);

            if (TileRedstoneFurnace.isBurning(this.furnace))
            {
