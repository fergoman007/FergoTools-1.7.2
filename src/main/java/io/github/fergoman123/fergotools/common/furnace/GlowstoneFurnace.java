...
{
    public static final class BlockGlowstoneFurnace extends BlockFurnaceFT
    {
        ...
        public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ) {
            if (!worldIn.isRemote && !playerIn.isSneaking())
            {
                ...
                if (furnace != null)
                {
                    openGui(FergoTools.instance, GuiIds.glowstoneFurnace.ordinal(), worldIn, pos, playerIn);
        ...
        public static void setState(boolean active, World world, BlockPos pos)
        {
            ...
            if (active)
            {
                world.setBlockState(pos, BlockStateHelper.getStateWithProps(ModBlocks.glowstoneFurnaceActive, FACING, state.getValue(FACING)), 3);
                world.setBlockState(pos, BlockStateHelper.getStateWithProps(ModBlocks.glowstoneFurnaceActive, FACING, state.getValue(FACING)), 3);
            }
            else
            {
                world.setBlockState(pos, BlockStateHelper.getStateWithProps(ModBlocks.glowstoneFurnaceIdle, FACING, state.getValue(FACING)), 3);
                world.setBlockState(pos, BlockStateHelper.getStateWithProps(ModBlocks.glowstoneFurnaceIdle, FACING, state.getValue(FACING)), 3);
            }
    ...
    public static final class TileGlowstoneFurnace extends TileFurnaceFergo
    {
        @Override
        public String getCommandSenderName() {
            return this.hasCustomName() ? this.customName : Locale.containerGlowstoneFurnace;
        }
        ...
        public int getFurnaceSpeed(ItemStack stack) {
            return FurnaceConstants.Speed.glowstoneFurnace;
        }
    ...
    public static final class ContainerGlowstoneFurnace extends ContainerFurnaceFergo
    {
        ...
        public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int slotIndex){
            ...
            if (slot != null && slot.getHasStack()){
                ...
                if (slotIndex == 2){
                    ...
                    }else if (TileGlowstoneFurnace.isItemFuel(itemstack1)){
    ...
    public static final class GuiGlowstoneFurnace extends GuiFurnaceFergo
    {
        public GuiGlowstoneFurnace(InventoryPlayer invPlayer, IInventory furnace)
        {
            super(new ContainerGlowstoneFurnace(invPlayer, furnace), invPlayer, furnace);
        }
        ...
        public void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
        {
            ...
            GuiHelper.bindTexture(Textures.glowstoneFurnaceGui);
            int startX = (width - xSize) / 2;
            int startY = (height - ySize) / 2;
            drawTexturedModalRect(startX, startY, 0, 0, xSize, ySize);

            if (TileGlowstoneFurnace.isBurning(this.furnace))
            {
