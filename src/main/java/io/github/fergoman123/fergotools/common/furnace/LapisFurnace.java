...
public class LapisFurnace
{
    ...
    public static final class BlockLapisFurnace extends BlockFurnaceFT
    {
        ...
        public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ) {
            if (!worldIn.isRemote && !playerIn.isSneaking())
            {
                ...
                if (furnace != null)
                {
                    openGui(FergoTools.instance, GuiIds.lapisFurnace.ordinal(), worldIn, pos, playerIn);
        ...
        public static void setState(boolean active, World world, BlockPos pos)
        {
            ...
            if (active)
            {
                world.setBlockState(pos, BlockStateHelper.getStateWithProps(ModBlocks.lapisFurnaceActive, FACING, state.getValue(FACING)), 3);
                world.setBlockState(pos, BlockStateHelper.getStateWithProps(ModBlocks.lapisFurnaceActive, FACING, state.getValue(FACING)), 3);
            }
            else
            {
                world.setBlockState(pos, BlockStateHelper.getStateWithProps(ModBlocks.lapisFurnaceIdle, FACING, state.getValue(FACING)), 3);
                world.setBlockState(pos, BlockStateHelper.getStateWithProps(ModBlocks.lapisFurnaceIdle, FACING, state.getValue(FACING)), 3);
            }
    ...
    public static final class TileLapisFurnace extends TileFurnaceFergo
    {
        @Override
        public String getCommandSenderName() {
            return this.hasCustomName() ? this.customName : Locale.containerLapisFurnace;
        }
        ...
        public void update() {
            ...
            if (!this.worldObj.isRemote) {
                ...
                if (flag != this.isBurning()) {
                    flag1 = true;
                    BlockLapisFurnace.setState(this.isBurning(), this.worldObj, this.pos);
                }
            }
        ...
        public int getFurnaceSpeed(ItemStack stack) {
            return FurnaceConstants.Speed.lapisFurnace;
        }
        ...
        public String getGuiID() {
            return "fergotools:lapisfurnace";
        }

        @Override
        public Container createContainer(InventoryPlayer invPlayer, EntityPlayer player) {
            return new ContainerLapisFurnace(invPlayer, this);
        }
    }

    public static final class ContainerLapisFurnace extends ContainerFurnaceFergo
    {
        ...
        public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int slotIndex){
            ...
            if (slot != null && slot.getHasStack()){
                ...
                if (slotIndex == 2){
                    ...
                    }else if (TileLapisFurnace.isItemFuel(itemstack1)){
    ...
    public static final class GuiLapisFurnace extends GuiFurnaceFergo
    {
        public GuiLapisFurnace(InventoryPlayer invPlayer, IInventory furnace)
        {
            super(new ContainerLapisFurnace(invPlayer, furnace), invPlayer, furnace);
        }
        ...
        public void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
        {
            ...
            GuiHelper.bindTexture(Textures.lapisFurnaceGui);
            int startX = (width - xSize) / 2;
            int startY = (height - ySize) / 2;
            drawTexturedModalRect(startX, startY, 0, 0, xSize, ySize);

            if (TileLapisFurnace.isBurning(this.furnace))
            {
