...
public class GuiQuartzFurnace extends GuiFurnaceFergo{

	public GuiQuartzFurnace(InventoryPlayer invPlayer, IInventory furnace) {
		super(new ContainerQuartzFurnace(invPlayer, furnace), GuiTextures.quartzFurnaceGui, invPlayer, furnace);
	}
