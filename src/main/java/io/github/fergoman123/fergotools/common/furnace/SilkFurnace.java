...
public class SilkFurnace
{
    public static final class BlockSilkFurnace extends BlockFurnaceFT
    {
        ...
        public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ) {
            if (!worldIn.isRemote && !playerIn.isSneaking())
            {
                ...
                if (furnace != null)
                {
                    openGui(FergoTools.instance, GuiIds.silkFurnace.ordinal(), worldIn, pos, playerIn);
        ...
        public static void setState(boolean active, World world, BlockPos pos)
        {
            ...
            if (active)
            {
                world.setBlockState(pos, BlockStateHelper.getStateWithProps(ModBlocks.silkFurnaceActive, FACING, state.getValue(FACING)), 3);
                world.setBlockState(pos, BlockStateHelper.getStateWithProps(ModBlocks.silkFurnaceActive, FACING, state.getValue(FACING)), 3);
            }
            else
            {
                world.setBlockState(pos, BlockStateHelper.getStateWithProps(ModBlocks.silkFurnaceIdle, FACING, state.getValue(FACING)), 3);
                world.setBlockState(pos, BlockStateHelper.getStateWithProps(ModBlocks.silkFurnaceIdle, FACING, state.getValue(FACING)), 3);
            }
    ...
    public static final class TileSilkFurnace extends TileFurnaceFergo
    {
        @Override
        public String getCommandSenderName() {
            return this.hasCustomName() ? this.customName : Locale.containerSilkFurnace;
        }
        ...
        public int getFurnaceSpeed(ItemStack stack) {
            return FurnaceConstants.Speed.silkFurnace;
        }
    ...
    public static final class ContainerSilkFurnace extends ContainerFurnaceFergo
    {
        ...
        public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int slotIndex){
            ...
            if (slot != null && slot.getHasStack()){
                ...
                if (slotIndex == 2){
                    ...
                    }else if (TileSilkFurnace.isItemFuel(itemstack1)){
    ...
    public static final class GuiSilkFurnace extends GuiFurnaceFergo
    {
        public GuiSilkFurnace(InventoryPlayer par1InventoryPlayer, IInventory furnace)
        {
            super(new ContainerSilkFurnace(par1InventoryPlayer, furnace), par1InventoryPlayer, furnace);
        }
        ...
        public void drawGuiContainerBackgroundLayer(float particleTicks, int mouseX, int mouseY)
        {
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
            GuiHelper.bindTexture(Textures.silkFurnaceGui);
            int startX = (width - xSize) / 2;
            int startY = (height - ySize) / 2;
            drawTexturedModalRect(startX, startY, 0, 0, xSize, ySize);

            if (TileSilkFurnace.isBurning(this.furnace))
            {
