...
public class OreDict {
    ...
    public static final String ingotCoal = oreDict + ItemNames.ingotCoal;
    public static final String ingotGlowstone = oreDict + ItemNames.ingotGlowstone;
    public static final String ingotAdamantium = oreDict + ItemNames.ingotAdamantium;

    public static final String gemEmerald = oreDict + ItemNames.gemEmerald;
    public static final String gemLapis = oreDict + ItemNames.gemLapis;
    public static final String gemRedstone = oreDict + ItemNames.gemRedstone;
