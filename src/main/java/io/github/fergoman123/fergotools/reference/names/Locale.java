...
public class Locale
{
    ...
    public static final String containerCoalWorkbench = containerPrefix + "coalWorkbench";
    public static final String containerGlowstoneWorkbench = containerPrefix + "glowstoneWorkbench";
    public static final String containerAdamantiumWorkbench = containerPrefix + "adamantiumWorkbench";
