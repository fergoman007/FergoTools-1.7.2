...
public class GlowstoneWorkbench
{
    ...
    public static final class ContainerGlowstoneWorkbench extends ContainerWorkbenchFT implements ContainerWorkbenchFT.IContainerWorkbenchFT
    {
        public ContainerGlowstoneWorkbench(InventoryPlayer inventory, World world, int x, int y, int z)
        {
    ...
    public static final class GuiGlowstoneWorkbench extends GuiWorkbenchFT
    {
        public GuiGlowstoneWorkbench(InventoryPlayer inventory, World world, int x, int y, int z)
        {
            super(new ContainerGlowstoneWorkbench(inventory, world, x, y, z));
        }

        @Override
        public void drawGuiContainerForegroundLayer(int par1, int par2) {
            this.fontRendererObj.drawString(I18n.format(Locale.containerGlowstoneWorkbench, new Object[0]), 28, 6, 4210752);
        ...
        public void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
            ...
            GuiHelper.bindTexture(Textures.glowstoneWorkbenchGuiTexture);
            int k = (width - xSize) / 2;
