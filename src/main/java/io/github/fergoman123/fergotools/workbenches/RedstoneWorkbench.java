...
public class RedstoneWorkbench
{
    ...
    public static final class ContainerRedstoneWorkbench extends ContainerWorkbenchFT implements ContainerWorkbenchFT.IContainerWorkbenchFT
    {
        public ContainerRedstoneWorkbench(InventoryPlayer inventory, World world, int x, int y, int z)
        {
    ...
    public static final class GuiRedstoneWorkbench extends GuiWorkbenchFT
    {
        public GuiRedstoneWorkbench(InventoryPlayer inventory, World world, int x, int y, int z)
        {
            super(new ContainerRedstoneWorkbench(inventory, world, x, y, z));
        }

        @Override
        public void drawGuiContainerForegroundLayer(int par1, int par2) {
            this.fontRendererObj.drawString(I18n.format(Locale.containerRedstoneWorkbench, new Object[0]), 28, 6, 4210752);
