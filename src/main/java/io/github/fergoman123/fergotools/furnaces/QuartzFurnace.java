...
public class QuartzFurnace
{
    public static final class BlockQuartzFurnace extends BlockFurnaceFT
    {
        ...
        {
            this.blockIcon = register.registerIcon(Textures.resourcePrefix + Names.Blocks.quartzFurnaceSide);
            this.icons[0] = register.registerIcon(Textures.resourcePrefix + (this.isActive ? Names.Blocks.quartzFurnaceActive : Names.Blocks.quartzFurnaceIdle));
            this.icons[1] = register.registerIcon(Textures.resourcePrefix + Names.Blocks.quartzFurnaceSide);
        }
        ...
        public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
        {
            ...
            else if (!player.isSneaking())
            {
                ...
                if (furnace != null)
                {
                    player.openGui(FergoTools.instance, GuiIds.quartzFurnace.ordinal(), world, x, y, z);
                }
                return true;
            }
            else
    ...
    public static final class TileEntityQuartzFurnace extends TileEntityFurnaceFT
    {
        ...
        {
            return this.hasCustomInventoryName() ? this.localizedName : Names.Locale.containerQuartzFurnace;
        }
        ...
        {
            return this.cookTime * speed / Ints.Furnace.quartzFurnaceSpeed;
        }
        ...
        public int getBurnTimeRemainingScaled(int speed)
        {
            ...
            {
                this.currentItemBurnTime = Ints.Furnace.quartzFurnaceSpeed;
            }
        ...
        public void updateEntity()
        {
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                {
                    flag1 = true;
                    BlockQuartzFurnace.updateBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
                }
            }
    ...
    public static final class ContainerQuartzFurnace extends ContainerFT
    {
    ...
    @SideOnly(Side.CLIENT)
    public static final class GuiQuartzFurnace extends GuiFT
    {
        private TileEntityQuartzFurnace furnace;
