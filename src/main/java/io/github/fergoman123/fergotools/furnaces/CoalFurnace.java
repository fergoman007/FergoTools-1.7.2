...
public class CoalFurnace
{
    public static final class BlockCoalFurnace extends BlockFurnaceFT
    {
        ...
        public BlockCoalFurnace(boolean isActive, Material material, String furnaceType)
        {
        ...
        {
            return Item.getItemFromBlock(FTContent.coalFurnaceIdle);
        }
        ...
        {
            this.blockIcon = register.registerIcon(Textures.resourcePrefix + BlockNames.blockCoal);
            this.icons[0] = register.registerIcon(Reference.textureLoc + (this.isActive ? BlockNames.coalFurnaceActive : BlockNames.coalFurnaceIdle));
            this.icons[1] = register.registerIcon(Textures.resourcePrefix + BlockNames.blockCoal);
        }
        ...
        public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
        {
            ...
            {
                TileEntityCoalFurnace furnace = (TileEntityCoalFurnace)world.getTileEntity(x, y, z);
                if (furnace != null)
                {
                    player.openGui(FergoTools.getInstance(), GuiIds.coalFurnace.ordinal(), world, x, y, z);
                }
                return true;
            }
            else
        ...
        public static void updateBlockState(boolean active, World world, int x, int y, int z)
        {
            ...
            if (active)
            {
                world.setBlock(x, y, z, FTContent.coalFurnaceActive);
            }
            else
            {
                world.setBlock(x, y, z, FTContent.coalFurnaceIdle);
            }
        ...
        public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase elb, ItemStack stack)
        {
            ...
            {
                ((TileEntityCoalFurnace)world.getTileEntity(x, y, z)).setGuiDisplayName(stack.getDisplayName());
            }
        }
    ...
    public static final class TileEntityCoalFurnace extends TileEntityFurnaceFT {
        ...
        public void updateEntity()
        {
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                {
                    flag1 = true;
                    BlockCoalFurnace.updateBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
                }
            }
    ...
    public static final class ContainerCoalFurnace extends ContainerFT
    {
        ...
        public ContainerCoalFurnace(InventoryPlayer par1InventoryPlayer, TileEntityCoalFurnace furnace)
        {
    ...
    @SideOnly(Side.CLIENT)
    public static final class GuiCoalFurnace extends GuiFT
    {
        private TileEntityCoalFurnace furnace;
