...
public class Macerator
{
    ...
    public static final class ContainerMacerator extends ContainerFT
    {
    ...
    @SideOnly(Side.CLIENT)
    public static final class GuiMacerator extends GuiFT
    {
        private TileEntityMacerator macerator;
    ...
    public static final class TileEntityMacerator extends TileEntityFurnaceFT {
