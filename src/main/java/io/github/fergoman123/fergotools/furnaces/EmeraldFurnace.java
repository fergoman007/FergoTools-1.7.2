...
import io.github.fergoman123.fergoutil.util.INBTTaggable;
...
public class EmeraldFurnace
 {
     ...
     public static final class TileEntityEmeraldFurnace extends TileEntityFurnaceFT implements INBTTaggable
     {
     ...
     @SideOnly(Side.CLIENT)
     public static final class GuiEmeraldFurnace extends GuiFT
     {
     ...
     public static final class ContainerEmeraldFurnace extends ContainerFT {
