...
public class SilkFurnace
{
    public static final class BlockSilkFurnace extends BlockFurnaceFT
    {
        ...
        public static void updateSilkFurnaceBlockState(boolean active, World world, int x, int y, int z)
        {
        ...
        public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase elb, ItemStack stack)
        {
            ...
            {
                ((TileEntitySilkFurnace)world.getTileEntity(x, y, z)).setGuiDisplayName(stack.getDisplayName());
            }
        }
    ...
    public static final class ContainerSilkFurnace extends ContainerFT
    {
        private int lastCookTime;
        private int lastBurnTime;
        private int lastItemBurnTime;

        private TileEntitySilkFurnace silkFurnace;

        public ContainerSilkFurnace(InventoryPlayer par1InventoryPlayer, TileEntitySilkFurnace furnace)
        {
            this.silkFurnace = furnace;
        ...
        public void addCraftingToCrafters(ICrafting par1ICrafting)
        {
            ...
            par1ICrafting.sendProgressBarUpdate(this, 0, this.silkFurnace.cookTime);
            par1ICrafting.sendProgressBarUpdate(this, 1, this.silkFurnace.burnTime);
            par1ICrafting.sendProgressBarUpdate(this, 2, this.silkFurnace.currentItemBurnTime);
        }
        ...
        public void detectAndSendChanges()
        {
            ...
            for (int i = 0; i < this.crafters.size(); ++i)
            {
                ...
                if (this.lastCookTime != this.silkFurnace.cookTime)
                {
                    icrafting.sendProgressBarUpdate(this, 0, this.silkFurnace.cookTime);
                }

                if (this.lastBurnTime != this.silkFurnace.burnTime)
                {
                    icrafting.sendProgressBarUpdate(this, 1, this.silkFurnace.burnTime);
                }

                if (this.lastItemBurnTime != this.silkFurnace.currentItemBurnTime)
                {
                    icrafting.sendProgressBarUpdate(this, 2, this.silkFurnace.currentItemBurnTime);
                }
            }

            this.lastCookTime = this.silkFurnace.cookTime;
            this.lastBurnTime = this.silkFurnace.burnTime;
            this.lastItemBurnTime = this.silkFurnace.currentItemBurnTime;
        }
        ...
        public void updateProgressBar(int par1, int par2)
        {
            if (par1 == 0)
            {
                this.silkFurnace.cookTime = par2;
            }

            if (par1 == 1)
            {
                this.silkFurnace.burnTime = par2;
            }

            if (par1 == 2)
            {
                this.silkFurnace.currentItemBurnTime = par2;
            }
        }

        public boolean canInteractWith(EntityPlayer par1EntityPlayer)
        {
            return this.silkFurnace.isUseableByPlayer(par1EntityPlayer);
        }
        ...
        public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
        {
            ...
            if (slot != null && slot.getHasStack())
            {
                ...
                else if (par2 != 1 && par2 != 0)
                {
                    ...
                    else if (TileEntitySilkFurnace.isItemFuel(itemstack1))
                    {
    ...
    @SideOnly(Side.CLIENT)
    public static final class GuiSilkFurnace extends GuiFT
    {
        private TileEntitySilkFurnace silkFurnace;
    ...
    public static final class TileEntitySilkFurnace extends TileEntityFurnaceFT {
