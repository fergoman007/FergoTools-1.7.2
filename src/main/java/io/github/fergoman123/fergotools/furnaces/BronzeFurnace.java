...
public class BronzeFurnace
{
    ...
    public static final class BlockBronzeFurnace extends BlockFurnaceFT
    {
        ...
        public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase elb, ItemStack stack)
        {
            ...
            {
                ((TileEntityBronzeFurnace)world.getTileEntity(x, y, z)).setGuiDisplayName(stack.getDisplayName());
            }
        }
    ...
    public static final class TileEntityBronzeFurnace extends TileEntityFurnaceFT
    {
        ...
        {
            return this.cookTime * speed / Ints.Furnace.bronzeFurnaceSpeed;
        }
        ...
        public int getBurnTimeRemainingScaled(int speed)
        {
            ...
            {
                this.currentItemBurnTime = Ints.Furnace.bronzeFurnaceSpeed;
            }
        ...
        public void updateEntity()
        {
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (this.isBurning() && this.canSmelt())
                {
                    ...
                    if (this.cookTime == Ints.Furnace.bronzeFurnaceSpeed)
                    {
                        this.cookTime = 0;
                        this.smeltItem();
                        flag1 = true;
                ...
                {
                    flag1 = true;
                    BlockBronzeFurnace.updateBronzeFurnaceBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
                }
            }
    ...
    public static final class ContainerBronzeFurnace extends ContainerFT
    {
    ...
    public static final class GuiBronzeFurnace extends GuiFT
    {
        private TileEntityBronzeFurnace furnace;
