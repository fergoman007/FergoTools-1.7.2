...
public class TileEntityGlowstoneFurnace extends TileEntity implements ISidedInventory, INBTTaggable{
    ...
    {
        return this.hasCustomInventoryName() ? this.localizedName : Strings.GuiStrings.containerGlowstoneFurnace;
    }
