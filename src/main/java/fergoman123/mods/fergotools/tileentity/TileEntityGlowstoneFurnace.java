...
public class TileEntityGlowstoneFurnace extends TileEntity implements ISidedInventory {
    ...
    /**
     * When some furnaceContainers are closed they call this on each slot, then drop whatever it returns as an EntityItem -
    ...
    {
        return this.hasCustomInventoryName() ? this.localizedName : GuiStrings.containerGlowstoneFurnace;
    }
    ...
    {
        return this.cookTime * par1 / FurnaceInts.glowstoneFurnaceSpeed;
    }
