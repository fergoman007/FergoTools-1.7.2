...
public class TileEntitySilkFurnace extends TileEntity implements ISidedInventory {
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.localizedName : GuiStrings.containerSilkFurnace;
    }
    ...
    public int getCookProgressScaled(int par1) {
        return this.cookTime * par1 / FurnaceInts.silkFurnaceSpeed;
    }
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote) {
            ...
            if (flag != this.burnTime > 0) {
                flag1 = true;
                BlockSilkFurnace.updateFurnaceBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
