...
public class TileEntityCoalFurnace extends TileEntity implements ISidedInventory, INBTTaggable{
    ...
    {
        return this.hasCustomInventoryName() ? this.localizedName : Strings.GuiStrings.containerCoalFurnace;
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockCoalFurnace.updateCoalFurnaceBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
