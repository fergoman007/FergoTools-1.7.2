...
public class TileEntityEmeraldCrystalFurnace extends TileEntity implements ISidedInventory {
    ...
    {
        return this.hasCustomInventoryName() ? this.localizedName : GuiStrings.containerEmeraldCrystalFurnace;
    }
    ...
    {
        return this.cookTime * par1 / FurnaceInts.emeraldFurnaceSpeed;
    }
