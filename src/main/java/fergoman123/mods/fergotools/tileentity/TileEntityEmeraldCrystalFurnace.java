...
public class TileEntityEmeraldCrystalFurnace extends TileEntity implements ISidedInventory{
    ...
    {
        return this.hasCustomInventoryName() ? this.localizedName : Strings.GuiStrings.containerEmeraldCrystalFurnace;
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockEmeraldCrystalFurnace.updateEmeraldcrystalFurnaceBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private static int getItemBurnTime(ItemStack stack)
    {
        ...
        else
        {
            ...
            if (item instanceof ItemBlock && BlockEmeraldCrystalFurnace.getBlockFromItem(item) != null)
            {
