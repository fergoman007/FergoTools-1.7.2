...
public class TileEntityLapisCrystalFurnace extends TileEntityFurnaceFT {
    ...
    {
        return this.cookTime * speed / FurnaceInts.lapisFurnaceSpeed;
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            if (this.isBurning() && this.canSmelt())
            {
                ...
                if (this.cookTime == FurnaceInts.lapisFurnaceSpeed)
                {
                    this.cookTime = 0;
                    this.smeltItem();
                    flag1 = true;
            ...
            {
                flag1 = true;
                BlockLapisCrystalFurnace.updateLapisFurnaceBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
