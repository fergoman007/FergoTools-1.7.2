...
public class TileEntityObsidianFurnace extends FurnaceTileFT{
    ...
    {
        return this.hasCustomInventoryName() ? this.localizedName : Strings.GuiStrings.containerObsidianFurnace;
    }
    ...
    {
        return this.cookTime * speed / FurnaceInts.obsidianFurnaceSpeed;
    }
