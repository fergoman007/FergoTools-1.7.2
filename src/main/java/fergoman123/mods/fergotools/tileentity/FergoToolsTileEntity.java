 ...
 */
public class FergoToolsTileEntity {

    public static TileStrings ts;
    public static GuiStrings gs;

    public static class TileEntityQuartzFurnace extends TileEntity implements ISidedInventory{
        ...
        public void readFromNBT(NBTTagCompound par1NBTTagCompound)
        {
            ...
            NBTTagList nbttaglist = par1NBTTagCompound.getTagList(ts.items, 10);
            this.slots = new ItemStack[this.getSizeInventory()];

            for (int i = 0; i < nbttaglist.tagCount(); ++i)
            {
                NBTTagCompound nbttagcompound1 = (NBTTagCompound)nbttaglist.getCompoundTagAt(i);
                byte b0 = nbttagcompound1.getByte(ts.slot);
            ...
            this.burnTime = par1NBTTagCompound.getShort(ts.burnTime);
            this.cookTime = par1NBTTagCompound.getShort(ts.cookTime);
            this.currentItemBurnTime = getItemBurnTime(this.slots[1]);

            if (par1NBTTagCompound.hasKey(TileStrings.customName))
            {
                this.localizedName = par1NBTTagCompound.getString(ts.customName);
            }
        }
        ...
        public void writeToNBT(NBTTagCompound par1NBTTagCompound)
        {
            ...
            par1NBTTagCompound.setShort(ts.burnTime, (short)this.burnTime);
            par1NBTTagCompound.setShort(ts.cookTime, (short)this.cookTime);
            ...
            for (int i = 0; i < this.slots.length; ++i)
            {
                if (this.slots[i] != null)
                {
                    ...
                    nbttagcompound1.setByte(ts.slot, (byte)i);
                    this.slots[i].writeToNBT(nbttagcompound1);
                    nbttaglist.appendTag(nbttagcompound1);
                }
            }

            par1NBTTagCompound.setTag(ts.items, nbttaglist);

            if (this.hasCustomInventoryName())
            {
                par1NBTTagCompound.setString(ts.customName, this.localizedName);
            }
        }
        ...
        public void updateEntity()
        {
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                {
                    flag1 = true;
                    BlockQuartzFurnace.updateFurnaceBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
                }
            }
    ...
    public static class TileEntityObsidianFurnace extends TileEntity implements ISidedInventory{
        ...
        @SideOnly(CLIENT)
        public int getCookProgressScaled(int par1){return this.cookTime * par1 / furnaceSpeed;}
    ...
    public static class TileEntityEmeraldCrystalFurnace extends TileEntity implements ISidedInventory{
        ...
        public String getInventoryName()
        {
            return this.hasCustomInventoryName() ? this.localizedName : GuiStrings.containers[2];
        }
        ...
        public void updateEntity()
        {
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                {
                    flag1 = true;
                    BlockEmeraldCrystalFurnace.updateFurnaceBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
                }
            }
    ...
    public static class TileEntityLapisCrystalFurnace extends TileEntity implements ISidedInventory {
    ...
    public static class TileEntityBronzeFurnace extends TileEntity implements ISidedInventory{
    ...
    public static class TileEntityCoalFurnace extends TileEntity implements ISidedInventory{
        private static final int[] slots_top = new int[] {0};
        private static final int[] slots_bottom = new int[] {2, 1};
        private static final int[] slots_sides = new int[] {1};
        ...
        public void updateEntity()
        {
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                {
                    flag1 = true;
                    BlockCoalFurnace.updateFurnaceBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
                }
            }
    ...
    public static class TileEntityGlowstoneFurnace extends TileEntity implements ISidedInventory{
        ...
        public void updateEntity()
        {
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                {
                    flag1 = true;
                    BlockGlowstoneFurnace.updateFurnaceBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
                }
            }
    ...
    public static class TileEntityAdamantiumFurnace extends TileEntityQuartzFurnace implements ISidedInventory {
        private static final int[] slots_top = new int[]{0};
        private static final int[] slots_bottom = new int[]{2, 1};
        private static final int[] slots_sides = new int[]{1};
