...
public class ObsidianFurnace
{
    ...
    public static final class TileEntityObsidianFurnace extends TileEntityFurnaceFT {
        ...
        {
            return this.cookTime * speed / Ints.Furnace.obsidianFurnaceSpeed;
        }
        ...
        public int getBurnTimeRemainingScaled(int speed)
        {
            ...
            {
                this.currentItemBurnTime = Ints.Furnace.obsidianFurnaceSpeed;
            }
        ...
        public void updateEntity()
        {
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                {
                    flag1 = true;
                    BlockObsidianFurnace.updateObsidianFurnaceBlockState(this.burnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
                }
            }
        ...
        private static int getItemBurnTime(ItemStack stack)
        {
            ...
            else
            {
                ...
                if (item instanceof ItemBlock && BlockObsidianFurnace.getBlockFromItem(item) != null)
                {
    ...
    public static final class ContainerObsidianFurnace extends ContainerFT
    {
        ...
        public ContainerObsidianFurnace(InventoryPlayer par1InventoryPlayer, TileEntityObsidianFurnace par2TileEntityFurnaceTutorial)
        {
    ...
    @SideOnly(Side.CLIENT)
    public static final class GuiObsidianFurnace extends GuiFT
    {
        private TileEntityObsidianFurnace furnace;
        ...
        public void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
        {
            ...
            GuiHelper.bindTexture(Textures.obsidianFurnaceGuiTexture);
            int k = (width - xSize) / 2;
