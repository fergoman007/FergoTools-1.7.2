package fergoman123.mods.fergotools.world.chunk.provider;
...
public class ChunkProviderFT implements IChunkProvider{
    ...
    public ChunkProviderFT(World par1World, long par2)
    {
