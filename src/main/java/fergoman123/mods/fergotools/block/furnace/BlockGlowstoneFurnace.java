...
public class BlockGlowstoneFurnace extends BlockContainer
{
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon(Reference.textureLoc + "blockGlowstone");
        this.iconFront = par1IconRegister.registerIcon(Reference.textureLoc + (this.isActive ? "glowstoneFurnaceActive" : "glowstoneFurnaceIdle"));
        this.iconTop = par1IconRegister.registerIcon(Reference.textureLoc + "blockGlowstone");
    }
    ...
    {
        return TileHandler.glowstoneFurnace;
    }
