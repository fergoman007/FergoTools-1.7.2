...
public class BlockAdamantiumFurnace extends BlockFurnaceFT
{
    ...
    {
        this.blockIcon = register.registerIcon(Textures.BlockTextures.blockAdamantium);
        this.icons[0] = register.registerIcon(Reference.textureLoc + (this.isActive ? Textures.FurnaceTextures.adamantiumFurnaceActive : Textures.FurnaceTextures.adamantiumFurnaceIdle));
        this.icons[1] = register.registerIcon(Textures.BlockTextures.blockAdamantium);
    }
