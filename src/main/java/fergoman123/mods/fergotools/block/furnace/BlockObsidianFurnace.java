...
public class BlockObsidianFurnace extends BlockContainer {
    ...
    {
     this.blockIcon = register.registerIcon(Reference.textureLoc + "blockObsidian");
     this.iconFront = register.registerIcon(Reference.textureLoc + (this.isActive ? "obsidianFurnaceActive" : "obsidianFurnaceIdle"));
     this.iconTop = register.registerIcon(Reference.textureLoc + "blockObsidian");
    }
