...
import fergoman123.mods.fergotools.tileentity.TileEntityNetherrackFurnace;
...
public class BlockNetherrackFurnace extends BlockFurnaceFT
{
    public static final Block instanceIdle = new BlockNetherrackFurnace(false).setCreativeTab(Tabs.tabFergoFurnaces);
    public static final Block instanceActive = new BlockNetherrackFurnace(true).setLightLevel(0.9f);

    private static boolean keepInventory;

    public BlockNetherrackFurnace(boolean isActive)
    {
        super(Material.rock, "netherrackFurnace");
    ...
    public void registerBlockIcons(IIconRegister register)
    {
        ...
        this.icons[0] = register.registerIcon(Reference.textureLoc + (this.isActive ? Names.Blocks.netherrackFurnaceActive : Names.Blocks.netherrackFurnaceIdle));
        this.icons[1] = register.registerIcon("netherrack");
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
    {
        ...
        {
            TileEntityNetherrackFurnace furnace = (TileEntityNetherrackFurnace)world.getTileEntity(x, y, z);
            if (furnace != null)
            {
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase elb, ItemStack stack)
    {
        ...
        {
            ((TileEntityNetherrackFurnace)world.getTileEntity(x, y, z)).setGuiDisplayName(stack.getDisplayName());
        }
    }
    ...
    public Block getIdle(){return instanceIdle;}

    public Block getActive(){return instanceActive;}

    public int getGuiID(){return GuiIds.netherrackFurnaceId;}
}
