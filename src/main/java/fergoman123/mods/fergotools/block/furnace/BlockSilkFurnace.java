 ...
 */
public class BlockSilkFurnace extends BlockContainer{
    ...
    {
        this.blockIcon = register.registerIcon(BlockTextures.blockSilkGem);
        this.iconFront = register.registerIcon(Reference.textureLoc + (this.isActive ? FurnaceTextures.silkFurnaceActive : FurnaceTextures.silkFurnaceIdle));
        this.iconTop = register.registerIcon(BlockTextures.blockSilkGem);
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
    {
        ...
        else if(!player.isSneaking())
        {
            ...
            if (furnace != null)
            {
                player.openGui(FergoTools.instance, 8, world, x, y, z);
            }
            return true;
        }
        else
    ...
    {
        return ModTiles.silkFurnace;
    }

    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase elb, ItemStack stack)
    {
        int l = MathHelper.floor_double((double)(elb.rotationYaw * 4.0f / 360) + 0.5D) & 3;
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6)
    {
        if (!keepInventory)
        {
            TileEntitySilkFurnace tileentityfurnace = (TileEntitySilkFurnace)par1World.getTileEntity(par2, par3, par4);
