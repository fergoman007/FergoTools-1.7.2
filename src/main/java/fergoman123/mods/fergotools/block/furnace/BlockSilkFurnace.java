...
public class BlockSilkFurnace extends BlockFurnaceFT
{
    ...
    {
        this.blockIcon = register.registerIcon(Textures.BlockTextures.blockSilkGem);
        this.icons[0] = register.registerIcon(Reference.textureLoc + (this.isActive ? Textures.FurnaceTextures.silkFurnaceActive : Textures.FurnaceTextures.silkFurnaceIdle));
        this.icons[1] = register.registerIcon(Textures.BlockTextures.blockSilkGem);
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
    {
        ...
        else if (!player.isSneaking())
        {
            ...
            if (furnace != null)
            {
                player.openGui(FergoTools.instance, GuiInts.silkFurnaceId, world, x, y, z);
            }
            return true;
        }
        else
