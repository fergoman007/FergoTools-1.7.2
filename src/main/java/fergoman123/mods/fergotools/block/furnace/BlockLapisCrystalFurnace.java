...
{
    public static final Block instanceIdle = new BlockLapisCrystalFurnace(false).setCreativeTab(CreativeTabsFergoTools.tabFergoFurnaces);
    ...
    {
        super(Material.rock, Strings.FurnaceType.lapisCrystalFurnace);
    ...
    public void registerBlockIcons(IIconRegister register)
    {
        ...
        this.icons[0] = register.registerIcon(Reference.textureLoc + (this.isActive ? Names.Blocks.lapisCrystalFurnaceActive : Names.Blocks.lapisCrystalFurnaceIdle));
    ...
    @Override
    public int getGuiID() {
        return GuiIds.lapisCrystalFurnace.ordinal();
    }
}
