...
public class BlockLapisCrystalFurnace extends BlockFurnaceFT
{
    ...
    {
        this.blockIcon = register.registerIcon(BlockTextures.blockLapisCrystal);
        this.icons[0] = register.registerIcon(Reference.textureLoc + (this.isActive ? FurnaceTextures.lapisCrystalFurnaceActive : FurnaceTextures.lapisCrystalFurnaceIdle));
        this.icons[1] = register.registerIcon(BlockTextures.blockLapisCrystal);
    }
