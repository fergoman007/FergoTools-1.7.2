...
{
    public static final Block instanceIdle = new BlockEmeraldCrystalFurnace(false).setCreativeTab(Tabs.tabFergoFurnaces);
    ...
    {
        super(Material.rock, "emeraldCrystalFurnace");
        this.isActive = isActive;
    }

    public Item getItemDropped(int par1, Random rand, int par3)
    {
        return UtilBlockItem.itemEmeraldcrystalFurnace;
    }
    ...
    {
        this.blockIcon = register.registerIcon(Textures.BlockTextures.blockEmeraldCrystal);
        this.icons[0] = register.registerIcon(Reference.textureLoc + (this.isActive ? Textures.FurnaceTextures.emeraldCrystalFurnaceActive : Textures.FurnaceTextures.emeraldCrystalFurnaceIdle));
        this.icons[1] = register.registerIcon(Textures.BlockTextures.blockEmeraldCrystal);
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ)
    {
        ...
        else if (!player.isSneaking())
        {
            ...
            if (furnace != null)
            {
                player.openGui(FergoTools.instance, GuiInts.emeraldCrystalFurnaceId, world, x, y, z);
            }
            return true;
        }
        else
    ...
    public static void updateEmeraldcrystalFurnaceBlockState(boolean active, World world, int x, int y, int z)
    {
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase elb, ItemStack stack)
    {
        ...
        {
            ((TileEntityEmeraldCrystalFurnace)world.getTileEntity(x, y, z)).setGuiDisplayName(stack.getDisplayName());
        }
    }
