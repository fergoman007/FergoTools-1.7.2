...
public class BlockEmeraldCrystalFurnace extends BlockFurnaceFT
{
    ...
    public void registerBlockIcons(IIconRegister register)
    {
        ...
        this.icons[0] = register.registerIcon(Reference.textureLoc + (this.isActive ? FurnaceTextures.emeraldCrystalFurnaceActive : FurnaceTextures.emeraldCrystalFurnaceIdle));
        this.icons[1] = register.registerIcon(BlockTextures.blockEmeraldCrystal);
    }
