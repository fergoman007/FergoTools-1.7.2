...
public class BlockEmeraldCrystalFurnace extends BlockFurnaceFT
{
    ...
    {
        this.blockIcon = register.registerIcon(Textures.resourcePrefix + Names.Blocks.blockEmeraldCrystal);
        this.icons[0] = register.registerIcon(Reference.textureLoc + (this.isActive ? Names.Blocks.emeraldCrystalFurnaceActive : Names.Blocks.emeraldCrystalFurnaceIdle));
        this.icons[1] = register.registerIcon(Textures.resourcePrefix + Names.Blocks.blockEmeraldCrystal);
    }
