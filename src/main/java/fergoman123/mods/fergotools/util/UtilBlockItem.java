...
public class UtilBlockItem {
    ...
    public static Item itemEmeraldcrystalFurnace = BlockHelper.getItemFromBlock(ModBlocks.emeraldFurnaceIdle);
    public static Item itemLapisCrystalFurnace = BlockHelper.getItemFromBlock(ModBlocks.lapisFurnaceIdle);
    public static Item itemBronzeFurnace = BlockHelper.getItemFromBlock(ModBlocks.bronzeFurnaceIdle);
    public static Item itemCoalFurnace = BlockHelper.getItemFromBlock(ModBlocks.coalFurnaceIdle);
