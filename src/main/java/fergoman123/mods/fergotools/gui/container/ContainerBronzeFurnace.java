...
public class ContainerBronzeFurnace extends Container{
    ...
    private FergoToolsTileEntity.TileEntityBronzeFurnace furnace;
	private int lastCookTime;
	private int lastBurnTime;
	private int lastItemBurnTime;
	
	public ContainerBronzeFurnace(InventoryPlayer player, FergoToolsTileEntity.TileEntityBronzeFurnace entity)
	{
		this.furnace = entity;
