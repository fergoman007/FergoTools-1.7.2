...
import static fergoman123.mods.fergotools.item.Armor.*;
import static fergoman123.mods.fergotools.item.Axes.*;
import static fergoman123.mods.fergotools.item.Bows.*;
import static fergoman123.mods.fergotools.item.CraftingMaterials.*;
import static fergoman123.mods.fergotools.item.Hammers.ItemObsidianHammer;
import static fergoman123.mods.fergotools.item.Hammers.ItemQuartzHammer;
import static fergoman123.mods.fergotools.item.Hoes.*;
import static fergoman123.mods.fergotools.item.Pickaxes.*;
import static fergoman123.mods.fergotools.item.Shovels.*;
import static fergoman123.mods.fergotools.item.Swords.*;
...
public class ModItems{
    ...
    public static Item quartzHammer;
    public static Item obsidianHammer;
    public static Item emeraldHammer;
    public static Item lapisHammer;
    public static Item bronzeHammer;
    public static Item coalHammer;
    public static Item glowstoneHammer;
    public static Item adamantiumHammer;
	...
	public static void addBows() {
        quartzBow = new ItemQuartzBow().setUnlocalizedName(BowStrings.bows[0]).setCreativeTab(Tabs.tabFergoBows).setMaxDamage(ToolInts.quartzMaxDamage).setMaxStackSize(1);
        obsidianBow = new ItemObsidianBow().setUnlocalizedName(BowStrings.bows[1]).setCreativeTab(Tabs.tabFergoBows).setMaxDamage(ToolInts.obsidianMaxDamage).setMaxStackSize(1);
        emeraldBow = new ItemEmeraldBow().setUnlocalizedName(BowStrings.bows[2]).setCreativeTab(Tabs.tabFergoBows).setMaxDamage(ToolInts.emeraldMaxDamage).setMaxStackSize(1);
        lapisBow = new ItemLapisBow().setUnlocalizedName(BowStrings.bows[3]).setCreativeTab(Tabs.tabFergoBows).setMaxDamage(ToolInts.lapisMaxDamage).setMaxStackSize(1);
        bronzeBow = new ItemBronzeBow().setUnlocalizedName(BowStrings.bows[4]).setCreativeTab(Tabs.tabFergoBows).setMaxDamage(ToolInts.bronzeMaxDamage).setMaxStackSize(1);
        coalBow = new ItemCoalBow().setUnlocalizedName(BowStrings.bows[5]).setCreativeTab(Tabs.tabFergoBows).setMaxDamage(ToolInts.coalMaxDamage).setMaxStackSize(1);
        glowstoneBow = new ItemGlowstoneBow().setUnlocalizedName(BowStrings.bows[6]).setCreativeTab(Tabs.tabFergoBows).setMaxDamage(ToolInts.glowstoneMaxDamage).setMaxStackSize(1);
        adamantiumBow = new ItemAdamantiumBow().setUnlocalizedName(BowStrings.bows[7]).setCreativeTab(Tabs.tabFergoBows).setMaxDamage(ToolInts.adamantiumMaxDamage).setMaxStackSize(1);
    }

    public static void addHammers()
    {

        quartzHammer = new ItemQuartzHammer(ToolArmorMaterials.quartz.getDamageVsEntity(), ToolArmorMaterials.quartz);
        obsidianHammer = new ItemObsidianHammer(ToolArmorMaterials.obsidian.getDamageVsEntity(), ToolArmorMaterials.obsidian);
    }
