...
public class Swords {
    ...
    public static class ItemAdamantiumSword extends ItemSword {
    ...
    public static class ItemBronzeSword extends ItemSword {
    ...
    public static class ItemCoalSword extends ItemSword {
    ...
    public static class ItemEmeraldSword extends ItemSword {
    ...
    public static class ItemGlowstoneSword extends ItemSword {
    ...
    public static class ItemLapisSword extends ItemSword {
    ...
    public static class ItemObsidianSword extends ItemSword {
    ...
    public static class ItemQuartzSword extends ItemSword {
    ...
    public static class ItemSilkSword extends ItemSword{
