...
public class ItemCoalBow extends ItemBowFT {

    public static ItemCoalBow instance = new ItemCoalBow();
    ...
    {
        super();
        this.setUnlocalizedName(Names.Items.bowCoal);
    ...
    public void registerIcons(IIconRegister register)
    {
        ...
        {
            this.texture[i] = register.registerIcon(Reference.textureLoc + Names.Items.bowCoal + pullArray[i]);
        }
    }
